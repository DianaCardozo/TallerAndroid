...
import com.example.applicationpokemon.services.driverAdapters.AdapterPokemon
import com.example.applicationpokemon.services.driverAdapters.AdapterEvolution
import com.example.applicationpokemon.services.models.TypeEntry
import com.example.applicationpokemon.ui.ActivityRegion

class PokemonActivity {
    class PokemonActivity : ComponentActivity() {

        val PokemonDiverAdapter by lazy { AdapterPokemon() }
        private val AdapterEvolution by lazy { AdapterEvolution() }


        override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
            setContent {
                val pokemonName = intent.getStringExtra("name_pokemon") ?: return@setContent
                val regionName = intent.getStringExtra("name_region") ?: return@setContent
